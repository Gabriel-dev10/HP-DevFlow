  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Pressable style={styles.option}><Text style={styles.optionText}>Notificações</Text><Text style={styles.optionValue}>Ativadas</Text></Pressable>
        <Pressable style={styles.option}><Text style={styles.optionText}>Tema</Text><Text style={styles.optionValue}>Automático</Text></Pressable>
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  option: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: 12, padding: spacing.md, flexDirection: 'row', justifyContent: 'space-between', marginBottom: spacing.sm },
